...
export default function SidebarItem({ name, onClick, image, bold }) {
  return (
    <div
      onClick={onClick}
      className={`group-[.active]:bg-purple-500 group-[.active]:text-white cursor-pointer flex items-center py-2 px-4 my-2 text-gray-300 hover:bg-yellow-500 hover:text-gray-100 rounded-md ${
