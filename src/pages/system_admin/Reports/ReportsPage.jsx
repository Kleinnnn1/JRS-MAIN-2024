...
const totalData = {
  ...
  totalRequests: departmentData.reduce(
    (acc, dept) => acc + dept.pending + dept.ongoing + dept.completed,
    0
  ),
};
        ...
        <div>
          ...
          <div className={pageStyle.container}>
            ...
            <div className="flex flex-wrap justify-between items-center gap-8 mt-8">
              ...
              <div className="flex-1 p-4 bg-white shadow-md rounded-lg">
                <h2 className="text-xl font-semibold mt-10 mb-4 text-center">Job Categories with Most Requests</h2>
                <JobCategory />
              </div>
            </div>
          </div>
