  ...
  const handleDepartmentChange = (id, deptId) => {
    ...
    setJobAccounts((prevAccounts) =>
      prevAccounts.map((account) =>
        account.id === id
          ? { ...account, deptId, jobCategory: "", jobCategories: jobCategoriesForDept }
          : account
      )
    );
  };
        ...
        {jobAccounts.map((account) => (
          <div key={account.id} className="space-y-4">
            <input
              ...
              onChange={(e) => handleInputChange(account.id, "idNumber", e.target.value)}
              required
            />
            <input
              type="text"
              ...
              className="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-300"
              value={account.fName}
              onChange={(e) => handleInputChange(account.id, "fName", e.target.value)}
              required
            />
            <input
              type="text"
              ...
              className="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-300"
              value={account.lName}
              onChange={(e) => handleInputChange(account.id, "lName", e.target.value)}
              required
            />
            <input
              type="date"
              ...
              onChange={(e) => handleInputChange(account.id, "birthDate", e.target.value)}
              required
            />
            <input
              type="email"
              ...
              className="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-300"
              value={account.email}
              onChange={(e) => handleInputChange(account.id, "email", e.target.value)}
              required
            />
            <input
              type="text"
              ...
              onChange={(e) => handleInputChange(account.id, "contactNumber", e.target.value)}
              required
            />
            ...
            <select
              ...
              onChange={(e) => handleDepartmentChange(account.id, Number(e.target.value))}
              required
            >
            ...
            <select
              ...
              onChange={(e) => handleInputChange(account.id, "jobCategory", e.target.value)}
              disabled={!account.deptId}
              required
            >
              <option value="" disabled>
                {account.deptId ? "Select Job Category" : "Select a department first"}
              </option>
