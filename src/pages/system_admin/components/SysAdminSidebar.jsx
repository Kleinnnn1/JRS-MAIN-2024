            ...
            <ul className="mt-2 space-y-2">
                <li>
                    <div
                        ...
                        className={`flex items-center px-5 py-2 text-gray-300 hover:bg-blue-980 hover:bg-yellow-600 rounded-md cursor-pointer ${isActive('/system_admin') ? 'bg-white-950 text-white font-bold' : ''}`}
                    >
                        <Home className="mr-5" />
                ...
                <li>
                    <div
                        ...
                        className={`flex items-center px-5 py-2 text-gray-300 hover:bg-blue-980 hover:bg-yellow-600 rounded-md cursor-pointer ${isActive('/system_admin/Users') ? 'bg-white-950 text-white font-bold' : ''}`}
                    >
                ...
                <li>
                    <div
                        ...
                        className={`flex items-center px-5 py-2 text-gray-300 hover:bg-blue-980 hover:bg-yellow-600 rounded-md cursor-pointer ${isActive('/system_admin/Job_Requests') ? 'bg-white-950 text-white font-bold' : ''}`}
                    >
                ...
                <li>
                    <div
                        ...
                        className={`flex items-center px-2 text-gray-300 hover:bg-blue-980 hover:bg-yellow-600 rounded-md cursor-pointer ${isActive('/system_admin/Departments') ? 'bg-white-950 text-white font-bold' : ''}`}
                    >
                ...
                <li>
                    <div
                        ...
                        className={`flex items-center px-2 py-1 text-gray-300 hover:bg-blue-980 hover:bg-yellow-600 rounded-md cursor-pointer ${isActive('/system_admin/History') ? 'bg-white-950 text-white font-bold' : ''}`}
                    >
