        ...
        >
          <div className="flex justify-center space-x-4">
            <ProfileTab
              name="User Account"
              className={
                location.pathname === "/office_head/myprofile/user_account"
                  ? "font-bold"
                  : ""
              }
              onClick={() =>
                navigate("/office_head/myprofile/user_account")
              }
            />
            <ProfileTab
              name="Change Avatar"
              className={
                location.pathname === "/office_head/myprofile/change_avatar"
                  ? "font-bold"
                  : ""
              }
              onClick={() =>
                navigate("/office_head/myprofile/change_avatar")
              }
            />
            <ProfileTab
              ...
              onClick={() =>
                navigate("/office_head/myprofile/change_password")
              }
            />
          </div>
        </ContentAndHeader>
