...
import {
  confirmationAlert,
  successAlert,
} from "../../../components/ReusableSweetAlert"; // Import ReusableSweetAlert
  ...
  const handleUpdateJobRequest = () => {
    confirmationAlert(
      ...
      () => {
        successAlert(
          "Updated!",
          "Your job request has been successfully updated."
        ).then(() => {
  ...
  return (
    <div className="p-6">
      <div className="bg-white border shadow-md shadow-black/5">
        {/* Header */}
        <div className="bg-custom-blue p-4 m-0">
        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            ...
            <div>
              ...
              <textarea
                className="mt-1 block w-full border border-gray-300 p-2 text-red-500"
                rows="3"
                readOnly
              >
